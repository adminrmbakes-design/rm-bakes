...
class User(UserMixin, db.Model):
    ...
    # =====================================
    # ACCOUNT ACTIVITY
    # (used by the admin Customer Network /
    ...
    def avatar_initial(self):
        ...
        return source.strip()[:1].upper() if source.strip() else "?"
...
class Product(db.Model):
    ...
    # Used to surface "newly launched" products (last 10 days) on
    # products.html/index.html that aren't already in one of the
    # marketing collections above.
    created_at = db.Column(
...
# =========================================
# SITE FEATURE (Platform Settings)
# =========================================

class SiteFeature(db.Model):
