...
def admin_user_details(user_id):
    ...
    can_promote = (not is_self) and user.user_id != 1
...
# =========================================
# PROMOTE / DEPROMOTE ADMINISTRATOR STATUS
# =========================================
...
def admin_toggle_admin(user_id):
    ...
    # =====================================
    # ACCESS DENIED — protected super-admin account
    # =====================================
    ...
    # =====================================
    # CANNOT DEPROMOTE THE FINAL ADMIN
    # =====================================
    ...
    if target_user.is_admin and not _other_active_admin_exists(
        ...
        flash(
            "You can't depromote the final administrator account 🔒",
            "danger"
        )
    ...
    create_admin_notification(
        ...
        message=(
            f"\nAdministrator:\n{session.get('admin_username')}\n\n"
            f"{'promoted' if target_user.is_admin else 'depromoted'}:\n"
    ...
    flash(
        f"{target_user.username} has been "
        f"{'promoted to' if target_user.is_admin else 'depromoted from'} "
        f"administrator ✨",
        "success"
    )
