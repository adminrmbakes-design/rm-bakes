...
@main_bp.route("/api/homepage-reviews")
def homepage_reviews_api():

    from database import ProductReview
    from flask import jsonify

    reviews = (
        ProductReview.query
        .filter(
            ProductReview.review_text != None,
    ...
    return jsonify([
        {
            ...
            "rating":        r.rating,
            "review_text":   r.review_text[:220] if r.review_text else "",
            "product_name":  r.product_name or "Overall",
